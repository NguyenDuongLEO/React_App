...
public class ParentPortalPage_034 extends BaseTest {
    @Test
    public void verifyStudentFNFilterWhichNOTContainsInRequestColumn(){
        loginSuccessfully();
        parentPortalPage.filtersButton.click();
        parentPortalPage.studentLastNameFilter.sendKeys("Nguyen111");
    ...
    public void checkingStudentFNFilterWhichNOTContainsInRequestColumn() {
        ...
        Set<String> studentLNCompare = new HashSet<String>();
        studentLNCompare.add("");
        if(setRequestStatus == studentLNCompare &&
                driver.findElement(By.xpath("//div[@class='query__filter']/a")).getText().toLowerCase().trim()=="student last name: nguyen111"){
            System.out.println("======================");
            System.out.println("Test Case ParentPortalPage_034 is PASSED!");
            System.out.println("======================");
        }
        else {
            System.out.println("======================");
            System.out.println("Test Case ParentPortalPage_034 is FAILED!");
            System.out.println("======================");
