...
public class ParentPortalPage_037 extends BaseTest {
    @Test
    public void verifyCancelFilters(){
        loginSuccessfully();
        parentPortalPage.filtersButton.click();
        parentPortalPage.cancelButton.click();
        checkingCancelFilters();
    }
    public void checkingCancelFilters(){
        waitElement();
        if(parentPortalPage.parentPortal.getText().trim().toLowerCase().equals("[ parent portal ]")&&
            ...
            System.out.println("======================");
            System.out.println("Test Case ParentPortalPage_037 is PASSED!");
            System.out.println("======================");
        }
        else {
            waitElement();
            System.out.println("======================");
            System.out.println("Test Case ParentPortalPage_037 is FAILED!");
            System.out.println("======================");
